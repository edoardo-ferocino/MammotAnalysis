...
MainPanel.Graphical.FractLast = uicontrol(MainPanel.Graphical.ParamsContainer,'Style','edit','String',num2str(MainPanel.Data.FractLast),...
    'Units','normalized','Position',[0 0 1/6 0.5],'HorizontalAlignment','Left','Callback',{@SetEditValue,'fractlast'},...
...
MainPanel.Graphical.BkgLast = uicontrol(MainPanel.Graphical.ParamsContainer,'Style','edit','String',num2str(MainPanel.Data.BkgLast),...
    'Units','normalized','Position',[2/5-0.05 0 1/6 0.5],'HorizontalAlignment','Left','Callback',{@SetEditValue,'bkglast'},...
...
MainPanel.Graphical.NumGate = uicontrol(MainPanel.Graphical.ParamsContainer,'Style','edit','String',num2str(MainPanel.Data.NumGates),...
    'Units','normalized','Position',[0.67 0 1/6 0.5],'String','10','HorizontalAlignment','Left','Callback',{@SetEditValue,'numgate'});
MainPanel.Graphical.TextNumGate = uicontrol(MainPanel.Graphical.ParamsContainer,'Style','text','String','Num gates',...
    'Units','normalized','Position',MainPanel.Graphical.NumGate.Position+[1/5 -0.1 0 0],'HorizontalAlignment','Left',...
