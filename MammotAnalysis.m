...
MainPanel.Graphical.SumChannelsRawIrfFile = uicontrol(MainPanel.Graphical.MainActionsContainer,'Style','pushbutton','String','Sum channel raw irf',...
    'Units','normalized','Position',MainPanel.Graphical.PlotIrf.Position+[0 2/5 0 0],'Callback',{@SumChannels,MainPanel,'IrfOnly'},...
    'Tag',strcat(MainPanel.Tag,MainPanel.spacer,'SumChannelsRawDatFile'));
