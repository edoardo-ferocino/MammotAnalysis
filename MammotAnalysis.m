...
MainPanel.Graphical.ParamsContainer = uipanel(MainPanel.Figure,'Title','Params','Units','normalized','OuterPosition',[0.58 0.9 0.1 0.10],...
    'Tag',strcat(MainPanel.Tag,MainPanel.spacer,'ParamsContainer'));
MainPanel.Graphical.FractLast = uicontrol(MainPanel.Graphical.ParamsContainer,'Style','edit','String','0.1',...
    'Units','normalized','Position',[0 0 1/5 0.5],'HorizontalAlignment','Left','Callback',{@SetEditValue,'fractlast'},...
    'Tag',strcat(MainPanel.Tag,MainPanel.spacer,'FractLast'));
MainPanel.Graphical.FractFirst = uicontrol(MainPanel.Graphical.ParamsContainer,'Style','edit','String','-0.9',...
    'Units','normalized','Position',MainPanel.Graphical.FractLast.Position+[0 1/2 0 0],'HorizontalAlignment','Left','Callback',{@SetEditValue,'fractfirst'},...
...
MainPanel.Graphical.TextFractFirst = uicontrol(MainPanel.Graphical.ParamsContainer,'Style','text','String','Fract first',...
    'Units','normalized','Position',MainPanel.Graphical.FractFirst.Position+[1/4 -0.1 0 0],'HorizontalAlignment','Left',...
...
MainPanel.Graphical.TextFractLast = uicontrol(MainPanel.Graphical.ParamsContainer,'Style','text','String','Fract last',...
    'Units','normalized','Position',MainPanel.Graphical.FractLast.Position+[1/4 -0.1 0 0],'HorizontalAlignment','Left',...
    'Tag',strcat(MainPanel.Tag,MainPanel.spacer,'TextFractLast'));
MainPanel.Graphical.BkgLast = uicontrol(MainPanel.Graphical.ParamsContainer,'Style','edit','String','190',...
    'Units','normalized','Position',[2/4-0.05 0 1/5 0.5],'HorizontalAlignment','Left','Callback',{@SetEditValue,'bkglast'},...
    'Tag',strcat(MainPanel.Tag,MainPanel.spacer,'BkgLast'));
MainPanel.Graphical.BkgFirst = uicontrol(MainPanel.Graphical.ParamsContainer,'Style','edit','String','180',...
    'Units','normalized','Position',MainPanel.Graphical.BkgLast.Position+[0 1/2 0 0],'HorizontalAlignment','Left','Callback',{@SetEditValue,'bkgfirst'},...
...
MainPanel.Graphical.TextBkgFirst = uicontrol(MainPanel.Graphical.ParamsContainer,'Style','text','String','Bkg first',...
    'Units','normalized','Position',MainPanel.Graphical.BkgFirst.Position+[1/4 -0.1 0 0],'HorizontalAlignment','Left',...
...
MainPanel.Graphical.TextBkgLast = uicontrol(MainPanel.Graphical.ParamsContainer,'Style','text','String','Bkg last',...
    'Units','normalized','Position',MainPanel.Graphical.BkgLast.Position+[1/4 -0.1 0 0],'HorizontalAlignment','Left',...
    'Tag',strcat(MainPanel.Tag,MainPanel.spacer,'TextBkgLast'));

MainPanel.Data.MinCountRateTresh = 150000-100000;
MainPanel.Data.MedianPercentageTreshold = (1-0.10);
...
MainPanel.Graphical.NumGate = CreateEdit(MainPanel.Graphical.GateContainer,'Units','normalized',...
    'Position',MainPanel.Graphical.SelectReferenceArea.Position+[0 1/2 -3/4 0],'String','10','HorizontalAlignment','Left','Callback',{@SetEditValue,'numgate'});
MainPanel.Graphical.TextNumGate = CreateText(MainPanel.Graphical.GateContainer,'Units','normalized',...
    'Position',MainPanel.Graphical.NumGate.Position+[1/4 0 0.05 0],'String','Num gates','HorizontalAlignment','Left');
